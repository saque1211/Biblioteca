      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="flex shrink-0 items-center gap-1">
            {book.wishlist && (
              <span className="text-accent-600 dark:text-accent-400" title="Lista de desejos" aria-label="Lista de desejos">
                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current"><path d="M6 4h12a1 1 0 0 1 1 1v15l-7-4-7 4V5a1 1 0 0 1 1-1z"/></svg>
              </span>
            )}
            {book.favorite && (
              <span className="text-rose-400" title="Favorito" aria-label="Favorito">
